...
npout <- fread("MehdisNPdata\\outputs_propagations_individual_noNorm.txt") # x0 is input heat, xss_t is propagated heat
npin <- fread("MehdisNPdata\\inputs_pi.txt")

stringNet <- fread("MehdisNPdata\\network_STRING_400cs.txt")
...
load("C:/Users/isido/github/TBRU_integration_data/data_clean/Cox_model/Cox_NG_screen_model.RData")
load("C:/Users/isido/github/TBRU_integration_data/data_clean/Cox_model/Cox_AWR_screen_model.RData")
# convert to human homologs !!!!


tbPPI <- fread("TBsecretedAPMS_NIHMS1503192-supplement-5.csv")

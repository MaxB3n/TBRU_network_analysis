...
vsSource.gg <- prepare_subnetworkForEnrichment(gg, "string", "group", subnet = "MehdiNP", reassign = F)
vsSource.en <- calculate_subnetworkEnrichment(vsSource.gg)


vsPaths.gg <- prepare_subnetworkForEnrichment(gg2, "string", "group", subnet = "MehdiNP", reassign = F)
vsPaths.en <- calculate_subnetworkEnrichment(vsPaths.gg)


vsBetw.gg <- prepare_subnetworkForEnrichment(gg3, "string", "group", subnet = "MehdiNP", reassign = F)
vsBetw.en <- calculate_subnetworkEnrichment(vsBetw.gg)


vsesx1.gg <- prepare_subnetworkForEnrichment(gg4, "string", "group", subnet = "MehdiNP", reassign = F)
vsesx1.en <- calculate_subnetworkEnrichment(vsesx1.gg)

vsComparison.gg <- prepare_subnetworkForEnrichment(gg5, "string", "group", subnet = "MehdiNP", reassign = F)
vsComparison.en <- calculate_subnetworkEnrichment(vsComparison.gg)


# PLOT ALL Enrichments
plot_subnetworkEnrichments(vsComparison.en, topn = 4, save = T,  name = "vs All PPI", dims = c(10,7))
                           , 
